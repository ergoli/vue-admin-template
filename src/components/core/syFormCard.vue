<template>
  <div>
    <el-form ref="syForm" 
      ...
      :model="models" :rules="rules" :label-position="form.config.labelPosition" :label-width="form.config.labelWidth + 'px'">
  ...
  methods: {
    ...
    getData () {
      return new Promise((resolve, reject) => {
        this.$refs.syForm.validate(valid => {
          if (valid) {
            resolve(this.models)
          } else {
